...
describe('ClickUp Spaces and Tasks E2E', () => {
  ...
  it('creates a space via API and deletes it via UI', () => {
    cy.apiCreateSpace().then(() => {
      ...
      spacesPage.spaceNameSideBarButton.should('be.visible', { timeout: 10000 }).click()
      spacesPage.overviewRecentArea.should('be.visible', { timeout: 10000 });

      spacesPage.spaceNameSettingsButton.should('be.visible', {timeout: 10000}).click();
      spacesPage.spaceNameSettongsDeleteButton.should('be.visible', {timeout: 10000}).click();
      spacesPage.spaceNameDeleteConfirmationButton.should('be.visible', {timeout: 10000}).click();
